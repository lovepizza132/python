...
from datetime import datetime   # 패키지 임포트 할 때
date =datetime.strptime(msg, "%Y-%m-%d : %H:%M:%S")
print()
year = msg[:10]
# print(msg[-8:-3])
# print(msg[:10].replace("-", " "))
...
""" [ 출력결과 ]
    ...
    5) '도'라는 단어의 갯수 구하기
"""
print(msg.index('행복'))  # index: 위치 찾아 줌, 없으면 오류
print(msg.find('가자'))   # find는: 위치 찾아 줌, 없으면 '-1'을 반환
print(msg.rfind('행복'))  # 오른쪽에서 왼쪽으로 (글자) 위치 찾아 줌
print(len(msg)) # msg.len() 불가능
print(msg.count('도'))
